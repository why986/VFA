...
class EncoderApp(nn.Module):
    def __init__(self, size, w_dim=512, in_channels=3):
        ...
        self.convs.append(ConvLayer(in_channels, channels[size], 1))
...
class Encoder(nn.Module):
    def __init__(self, size, dim=512, dim_motion=20, in_channels=3):
        super(Encoder, self).__init__()

        # appearance netmork
        self.net_app = EncoderApp(size, dim, in_channels=in_channels)
